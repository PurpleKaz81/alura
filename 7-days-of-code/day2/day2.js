...
if (firstName && lastName && age && language && languageStudy) {
  document.getElementById("welcome").innerHTML = `Welcome to the Pleasuredome, ${firstName} ${lastName}. You're ${age} years old, too young to reason and too grown up to dream. Relax when you wanna come 🫦`
